<template>
  <div>
    ...
    >
        ...
        <el-table-column prop="bankidentity" :label="$t('AppMain.Bankidentity')" width="180" />
        ...
        <el-table-column prop="custodianid" :label="$t('AppMain.Custodianid')" width="180" />
        <el-table-column prop="payconfirm" :label="$t('AppMain.Payconfirm')" width="180" />
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('global.Show')+$t('global.Details')">
      <el-form :model="form" :inline="true" size="mini" :disabled="!isEdit">
          ...
          <el-input v-model="form.childflag" autocomplete="off" />
                ...
                <el-form-item :label-width="formLabelWidth" :label="$t('AppMain.Bankidentity')">
          <el-input v-model="form.bankidentity" autocomplete="off" />
        </el-form-item>
          ...
          <el-input v-model="form.cifid" autocomplete="off" />
                ...
                <el-form-item :label-width="formLabelWidth" :label="$t('AppMain.Custodianid')">
          <el-input v-model="form.custodianid" autocomplete="off" />
        </el-form-item>
                <el-form-item :label-width="formLabelWidth" :label="$t('AppMain.Payconfirm')">
          <el-input v-model="form.payconfirm" autocomplete="off" />
        </el-form-item>
              </el-form> 
...
import custodianApi from "@/api/biz/manager/custodian/custodian.js";
...
          arr.limit = pageSize;
    ...
    update() {
      if (this.isEdit) {
        ...
        custodianApi.update(arr, result => {
          this.$message({
            type: "success",
    ...
    deleteClick(row) {
      this.$confirm(this.$t('global.ConfirmDelete'), this.$t('global.Warn'), {
        ...
        .then(() => {
          ...
          custodianApi.remove(arr, result => {
            if (result.status === 200) {
              this.$message({
                type: "success",
