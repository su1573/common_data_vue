<template>
  <div>
    ...
    >
        ...
        <el-table-column prop="accmngcode" :label="$t('AppMain.Accmngcode')" width="180" />
        <el-table-column prop="accmngname" :label="$t('AppMain.Accmngname')" width="180" />
        ...
        <el-table-column prop="accmngid" :label="$t('AppMain.Accmngid')" width="180" />
    ...
    <el-dialog :visible.sync="dialogFormVisible" :title="$t('global.Show')+$t('global.Details')">
      <el-form :model="form" :inline="true" size="mini" :disabled="!isEdit">
                <el-form-item :label-width="formLabelWidth" :label="$t('AppMain.Accmngcode')">
          <el-input v-model="form.accmngcode" autocomplete="off" />
        </el-form-item>
                <el-form-item :label-width="formLabelWidth" :label="$t('AppMain.Accmngname')">
          <el-input v-model="form.accmngname" autocomplete="off" />
        </el-form-item>
          ...
          <el-input v-model="form.cifid" autocomplete="off" />
                ...
                <el-form-item :label-width="formLabelWidth" :label="$t('AppMain.Accmngid')">
          <el-input v-model="form.accmngid" autocomplete="off" />
        </el-form-item>
              </el-form> 
...
import accmanagerApi from "@/api/biz/manager/accmanager/accmanager.js";
...
          arr.limit = pageSize;
    ...
    update() {
      if (this.isEdit) {
        ...
        accmanagerApi.update(arr, result => {
          this.$message({
            type: "success",
    ...
    deleteClick(row) {
      this.$confirm(this.$t('global.ConfirmDelete'), this.$t('global.Warn'), {
        ...
        .then(() => {
          // 请求后台，成功后调用
          var arr = {
            accmngcode: row.accmngcode
          };
          accmanagerApi.remove(arr, result => {
            if (result.status === 200) {
              this.$message({
                type: "success",
